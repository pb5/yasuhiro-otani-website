...
- `profile.html` — プロフィール（ポートレート写真プレースホルダー）
- `artistic.html` — 音楽活動（音楽家としての芸術活動：演奏・自主制作楽曲・Max/MSPサウンド作品・既存プロジェクト「Thresholds」アーカイブへのリンク）
...
- `profile.html` — プロフィール写真（現在はシルエットのプレースホルダー）・経歴文
