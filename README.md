...
- `found.html` — QR landing page (`noindex`) for a low-cost street-art/sticker campaign (flyer/sticker assets are not in this repo, generated separately); intense glitch WebGL background reserved for this "reveal" moment
